...
enum gui_parameters_display_type {display_sphere, display_character, display_cylinder_bending, display_cylinder_translate, display_rondinella, display_bar,
                                  display_girafe, display_spot, display_dragon, display_snail, display_armadillo, display_binary};
struct gui_parameters
{
    ...
    bool gpu_color_floppy_weight = false;
    bool gpu_floppy_limit = false;
    bool gpu_floppy_weight_active = false;
    bool gpu_velocity_skinning = true;
...
struct scene_model : scene_base
{
    ...
    vcl::buffer<vcl::vec3> point_set_raw;
    vcl::buffer <vcl::uint3 > connectivity_raw;
    vcl::buffer <vcl::vec3> normal_raw;
    vcl::buffer <vcl::vec2> texture_uv_raw;
    vcl::buffer<float> floppy_weights_raw;

    int N_cow;
    vcl::buffer<vcl::vec3> position_cow_raw;
    GLuint buffer_position_cow_raw;
    GLuint texture_position_cow_raw;

    vcl::buffer<float> angle_cow_raw;
    GLuint buffer_angle_cow_raw;
    GLuint texture_angle_cow_raw;
    ...
    GLuint vao_raw;
    GLuint buffer_vertex_raw;
    GLuint buffer_normal_raw;
    GLuint buffer_texture_uv_raw;
    GLuint buffer_connectivity_raw;
    vcl::buffer<std::string> joint_name_raw;

    GLuint buffer_floppy_weights_raw;
    GLuint texture_floppy_weights_raw;
    
    GLuint buffer_rig_joint;
    GLuint texture_rig_joint;
    GLuint buffer_rig_weight;
    GLuint texture_rig_weight;
    GLuint buffer_rig_cumulative_index;
    GLuint texture_rig_cumulative_index;
    GLuint buffer_rig_size;
    GLuint texture_rig_size;


    GLuint buffer_vs_rig_joint, texture_vs_rig_joint;
    GLuint buffer_vs_rig_weight, texture_vs_rig_weight;
    GLuint buffer_vs_rig_cumulative_index, texture_vs_rig_cumulative_index;
    GLuint buffer_vs_rig_size, texture_vs_rig_size;


    GLuint buffer_angular_velocity_anim;
    GLuint texture_angular_velocity_anim;
    GLuint buffer_linear_velocity_anim;
    GLuint texture_linear_velocity_anim;
    GLuint buffer_T_anim;
    GLuint texture_T_anim;

    GLuint shader_skinning;
    GLuint texture_skinning_weights;
    GLuint texture_velocity_skinning_weights;
    GLuint buffer_skinning_weights;
    GLuint buffer_velocity_skinning_weights;
    ...
    GLuint buffer_center_of_mass;
    GLuint texture_center_of_mass;
    ...
    vcl::buffer<vcl::mat4> buffer_tbo_sk0;
    vcl::buffer<vcl::mat4> buffer_tbo_sk;
    vcl::buffer<vcl::vec3> buffer_tbo_angular_velocity, buffer_tbo_linear_velocity;
    GLuint tbo_sk0, tbo_sk, tbo_angular_velocity, tbo_linear_velocity;
    GLuint tex_sk0, tex_sk, tex_angular_velocity, tex_linear_velocity;
